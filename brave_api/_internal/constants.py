"""Internal constants for the Brave endpoints and default values.
...
SAFESEARCH_DEFAULT: Final[Literal["off", "moderate", "strict"]] = "moderate"
UNITS_DEFAULT: Final[Literal["metric", "imperial"]] = "metric"
